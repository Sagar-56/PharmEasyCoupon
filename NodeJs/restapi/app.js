...
// filter on the basis of package_size

app.get('/filters/:pId', (req,res) => {
    let pId = Number(req.params.pId)
    let flavorId = Number(req.query.flavorId)
    ...
    if(flavorId){
        query = {
            "package_size.p_id":pId,
            "flavor.flavor_id":flavorId
        }
    }else if(lcost && hcost){
        query = {
            "package_size.p_id":pId,
